...
int64 nChainStartTime = 1405840540;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 6500000000 * COIN;	// 6.5 billion coins, that all pow coins
...
const int YEARLY_BLONICOUNT = 525600;	// 365 * 1440 
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    int64 nRewardCoinYear;
	nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE;

	if(nHeight < YEARLY_BLONICOUNT)
		nRewardCoinYear = 30 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (2 * YEARLY_BLONICOUNT))
		nRewardCoinYear = 20 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (3 * YEARLY_BLONICOUNT))
		nRewardCoinYear = 10 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (4 * YEARLY_BLONICOUNT))
		nRewardCoinYear = 5 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (5 * YEARLY_BLONICOUNT))
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Nicecoin
    bool fStrictPayToScriptHash = true; // Always active in Nicecoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Nicecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Nicecoin Developers 1405840540";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x5cb6f6c7723d04154b52defb5654816b7c5624da140c7d093eb2951b40147627"));
